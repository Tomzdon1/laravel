 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PolicyStatus extends \App\apiModels\ApiModel implements ArrayAccess 
{
    /**
    ...
    /**
      * $policy_id Identyfikator polisy w systemie docelowym
      * @var string
      */
    public $policy_id;
    
    /**
      * $policy_status Status polisy w systemie docelowym
      * @var string
      */
    ...
    {
        $allowed_values = array("TEMPORARY", "FIXED", "CANCELED");
        if (!in_array($policy_status, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'policy_status', must be one of 'TEMPORARY', 'FIXED', 'CANCELED'");
        }
