...
class Envelope implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("policy-issue-request", "policy-status", "sms-send-request", "sms-status");
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'policy-issue-request', 'policy-status', 'sms-send-request', 'sms-status'");
        }
