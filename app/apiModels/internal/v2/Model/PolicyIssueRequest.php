 ...
 *
 * @category    Class */
 // @description Żądanie zapisania polisy w systemach docelowych
/**
 * @package     App\apiModels\internal\v2
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache License v2
...
class PolicyIssueRequest implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'insureds' => '\App\apiModels\internal\v2\Model\Insured[]',
        'solicitors' => '\App\apiModels\internal\v2\Model\Solicitor[]',
        ...
        'offer_definition' => '\App\apiModels\internal\v2\Model\OfferDefinition'
    ];
    ...
    protected static $setters = [
        ...
        'partner' => 'setPartner',
        'offer_definition' => 'setOfferDefinition'
    ];
    ...
    protected static $getters = [
        ...
        'partner' => 'getPartner',
        'offer_definition' => 'getOfferDefinition'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['insureds'] = isset($data['insureds']) ? $data['insureds'] : null;
        $this->container['solicitors'] = isset($data['solicitors']) ? $data['solicitors'] : null;
        ...
        $this->container['offer_definition'] = isset($data['offer_definition']) ? $data['offer_definition'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['insureds'] === null) {
            $invalid_properties[] = "'insureds' can't be null";
        }
        ...
        if ($this->container['offer_definition'] === null) {
            $invalid_properties[] = "'offer_definition' can't be null";
        }
    ...
    public function setDestination($destination)
    {
        ...
        if (!is_null($destination) && (!preg_match("/^[A-Z]{2}$/", $destination))) {
            throw new \InvalidArgumentException("invalid value for $destination when calling PolicyIssueRequest., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    /**
     * Sets insureds
     * @param \App\apiModels\internal\v2\Model\Insured[] $insureds Dane ubezpieczonych
     * @return $this
     */
    ...
    /**
     * Gets solicitors
     * @return \App\apiModels\internal\v2\Model\Solicitor[]
     */
    public function getSolicitors()
    {
        return $this->container['solicitors'];
    }

    /**
     * Sets solicitors
     * @param \App\apiModels\internal\v2\Model\Solicitor[] $solicitors Informacje o OWCA biorących udział w sprzedaży polisy
     * @return $this
     */
    public function setSolicitors($solicitors)
    {
        $this->container['solicitors'] = $solicitors;
    ...
    /**
     * Gets offer_definition
     * @return \App\apiModels\internal\v2\Model\OfferDefinition
     */
    public function getOfferDefinition()
    {
        return $this->container['offer_definition'];
    }

    /**
     * Sets offer_definition
     * @param \App\apiModels\internal\v2\Model\OfferDefinition $offer_definition
     * @return $this
     */
    public function setOfferDefinition($offer_definition)
    {
        $this->container['offer_definition'] = $offer_definition;
